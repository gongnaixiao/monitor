...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see cn.lesaas.service.impl.PasswordTokenManager#generateRecoveryToken(cn.lesaas.model.User)
     */
    @Override
    ...
    /**
     * @see cn.lesaas.service.impl.PasswordTokenManager#isRecoveryTokenValid(cn.lesaas.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see cn.lesaas.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
