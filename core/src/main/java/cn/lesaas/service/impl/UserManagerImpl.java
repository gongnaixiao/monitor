...
import cn.lesaas.dao.UserDao;
import cn.lesaas.model.User;
import cn.lesaas.service.MailEngine;
import cn.lesaas.service.UserExistsException;
import cn.lesaas.service.UserManager;
import cn.lesaas.service.UserService;
...
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see cn.lesaas.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
