package cn.lesaas.dao.hibernate;

import cn.lesaas.dao.GenericDao;
import cn.lesaas.dao.SearchException;
 ...
 * <pre>
 *      &lt;bean id="fooDao" class="cn.lesaas.dao.hibernate.GenericDaoHibernate"&gt;
 *          &lt;constructor-arg value="cn.lesaas.model.Foo"/&gt;
 *      &lt;/bean&gt;
 * </pre>
 *
